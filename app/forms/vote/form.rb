...
class Vote
  class Form
    ...
    attribute :poll_id
    attribute :votes_attributes, default: []
    ...
    before_validation :build_votes_from_responses
    ...
    def build_votes_from_responses
      return unless poll && responses.is_a?(Hash)

      self.votes_attributes = responses.map do |option_id, response|
